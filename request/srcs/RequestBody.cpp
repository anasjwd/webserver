...
// 	if (_rawData.find(endBoundary) == std::string::npos)
// 		return setState(false, BAD_REQUEST);
...
// {
//     if (_contentType.empty() || _contentType == "application/json" || 
//         _contentType.find("application/x-www-form-urlencoded") != std::string::npos)
//     {
//         _isParsed = true;
//         return true;
//     }
...
//         // std::string bodyStr(_data.begin(), _data.end());
//         // std::string startBoundary = "--" + _boundary;
//         // std::string endBoundary = "--" + _boundary + "--";
        
//         // if (bodyStr.find(startBoundary) == std::string::npos || 
//         //     bodyStr.find(endBoundary) == std::string::npos)
//         //     return false;
